...
public class CardGames {
    ...
    //Get number of Player and its info 
    ...
    public void ShuffleCard(){
        ...
        for(int count = 1; count <= 52; count++){
            ...
            temp = Cards.get(indexA); //Random Card 1 save to temp
            Cards.set(indexA,Cards.get(indexB)); // Random Card 2 replace Random Card 1
            Cards.set(indexB,temp); // temp replace Random Card 2
        }
    }
    ...
    public void SplitCards(ArrayList<Player> players) {
        ...
        int m = 0;
        for (Player pl : players)// split card for every player
        {
    ...
    public void DisplayCard() {
        ...
        int playernum = 0;
        for (Player pl : players) // display card for each player
        {
    ...
    public void ChooseCard(int Noplayer, Player pl,  ArrayList<Card> compare) {
        ...
        //Let players Selected their Card 
        ...
        //Save all selected card into array list to compare later
    ...
    public void CompareCards(ArrayList<Card> c) {
        ...
        for (int i = 0; i < c.size() - 1; i++) {
            ...
            //compare the ranks if it si same ranks the only compare the suits
        ...
        //Winner name and selector card will be display
    ...
    public void displayScores() {
    	...
    	// all players scores will be display
        for (int i = 0; i < players.size(); i++) {
    ...
    public void displayWinner(){
        ...
        int largest = 0;
        int samenum = 0;
        // The player with higher scores will win the game
        ...
        if (samenum == 0) {
        	...
        	// 2 Player have same highest scores
        	System.out.println("---------------------------------------");
    ...
    public CardGames() {
    	...
    	// create new card with suits, suits index and ranks, ranks index
        int index = 0;
    ...
    public void showCards() {
    	...
    	// Print out all the card in hand card
